...
namespace Nocturne
{
	...
	public delegate void OnColliderEnter( Collider other, Collider self );
	public delegate void OnColliderExit( Collider other, Collider self );
	public abstract class Collider : Component
	{
		...
		//these delegates below will only invoke if it is a trigger
		public OnColliderEnter OnColliderEnterEvent;
		public OnColliderExit OnColliderExitEvent;
		...
		public override void Added(Entity entity)
		{
			...
			if ( _colliderRequiresAutoSizing )
			{
				...
				var drawable = Entity.Get<RenderableComponent>();
				
				Debug.WarnIf( drawable == null,
					"Collider has no shape and no RenderableComponent. Can't figure out how to size it." );
				
				if ( drawable != null )
				{
					var renderableBounds = drawable.Bounds;
		...
		public virtual void OnColliderEnter( Collider other )
		{
			OnColliderEnterEvent?.Invoke( other, this );
		}

		public virtual void OnColliderExit( Collider other )
		{
			OnColliderExitEvent?.Invoke( other, this );
		}
		#endregion
		...
		#region Flag Utils
		public void SetPhysicsLayerWithEnum<TEnum>( TEnum value ) where TEnum : struct, Enum
		{
			// Flags.SetFlag( ref PhysicsLayer, Convert.ToInt32( value ) );
			PhysicsLayer |= Convert.ToInt32( value );
		}

		public void UnsetPhysicsLayerWithEnum<TEnum>(TEnum value) where TEnum : struct, Enum
		{
			// Flags.UnsetFlag( ref PhysicsLayer, Convert.ToInt32( value ) );
			PhysicsLayer &= ~Convert.ToInt32( value );
		}
		public void SetCollidesWithLayerWithEnum<TEnum>( TEnum value ) where TEnum : struct, Enum
		{
			// Flags.SetFlag( ref CollidesWithLayers, Convert.ToInt32( value ) );
			CollidesWithLayers |= Convert.ToInt32( value );
		}

		public void UnsetCollidesWithLayerWithEnum<TEnum>( TEnum value ) where TEnum : struct, Enum
		{
			// Flags.UnsetFlag( ref CollidesWithLayers, Convert.ToInt32( value ) );
			CollidesWithLayers &= ~Convert.ToInt32( value );
		}
		#endregion
	}
