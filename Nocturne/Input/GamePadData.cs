...
namespace Nocturne
{
    public class GamePadData
    {
        ...
        /// <summary>
        /// true only if the button is not down, and was down the previous frame
        /// </summary>
        ...
        {
            Vector2 res = _currentState.ThumbSticks.Left;
        ...
        {
            Vector2 res = _currentState.ThumbSticks.Right;
