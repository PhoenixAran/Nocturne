...
namespace Nocturne.PhysicsShapes
{
    public class Polygon : Shape
    {
        /// <summary>
        /// the points that make up the Polycon. They whould be CW and convex
        /// </summary>
        public Vector2[] Points;

        /// <summary>
        /// edge normals are used for SAT collision detection. We cache them to avoid
        /// the squareroots. Note that Boxes will only have 2 edgeNormals since the other
        ...
        /// <summary>
        /// builds the Polygon edge normals. These are lazily created and updated only by the 
        /// edgeNoramls getter
        /// </summary>
        void BuildEdgeNormals()
        {
            // for boxes we only require 2 edges wince the other 2 are parallel
            ...
            for ( int i = 0; i < totalEdges; ++i )
            {
                ...
                Vector2 perp = Vector2Ext.Perpendicular( ref p1, ref p2 );
        ...
        /// <summary>
        /// builds a symmetrical polygon (hexagon, octagon, n-gon) and returns the points
        /// </summary>
        ...
        /// <summary>
        /// finds the center of the Polygon. Note that this will be accurate for regular polygons. 
