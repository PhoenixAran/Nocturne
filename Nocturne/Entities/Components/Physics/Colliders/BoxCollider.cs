...
namespace Nocturne
{
	public class BoxCollider : Collider
	{
		...
		public override void DebugRender()
		{
			...
			Draw.HollowRect( Bounds.X, Bounds.Y, Bounds.Width, Bounds.Height, Debug.Colors.ColliderEdge );
			...
			Draw.Point( Entity.Transform.Position + Shape.center, Debug.Colors.ColliderCenter );
		}
