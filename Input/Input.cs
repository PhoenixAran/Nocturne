...
namespace Nocturne
{
    public static class Input
    {
        ...
        static internal List<VirtualInput> _virtualInputs = new List<VirtualInput>( 1 );
		...
		/// when rendering is embedded in a larger window so that mouse coordinates can be translated
		/// to Monogame space from the outer window coordinates and for simulating mouse input.
		/// </summary>
