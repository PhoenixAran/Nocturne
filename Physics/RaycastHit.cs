...
namespace Nocturne
{
    public struct RaycastHit
    {
        ...
        /// <summary>
        /// Fraction of the distance along the ray that the hit
        /// occured
        /// </summary>
        public float Fraction;

        /// <summary>
        /// The distance of the ray origin to the impact point
        /// </summary>
        public float Distance;

        /// <summary>
        /// The point in world space where the ray hit the collider's
        /// surface
        /// </summary>
        ...
        /// Where the shape would be positioned for it to contact.
        /// </summary>
